...
logger = log_handler.LogHandler('HTTPClient')
...
def _set_header_default():
    ...
    header_dict["User-Agent"] = "Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/63.0.3239.132 Safari/537.36"
            ...
            try:
                ...
                if response.status_code == 200 or response.status_code == 302:
                    ...
                    if response.content:
                        ...
                        logger.info(u"url: {} 返回参数为空".format(urls["req_url"]))
                        continue
                else:
                    sleep(urls["re_time"])
